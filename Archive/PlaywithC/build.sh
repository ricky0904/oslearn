...
nasm -f elf32 -g -F dwarf ./src/flush.asm -o ./build/flush_elf32.o # this gives elf64 output 
...
ld -m elf_i386 -Ttext=0x7c00 ./build/boot_elf32.o ./build/a20test_elf32.o ./build/longjmp_elf32.o ./build/printchar.o -o ./build/debug_symbols.elf # set function starting point at 0x7c00
