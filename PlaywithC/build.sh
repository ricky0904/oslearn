...
ld -m elf_i386 -Ttext=0x7c00 ./build/boot_elf32.o ./build/a20test_elf32.o ./build/longjmp_elf32.o ./build/flush_elf32.o -o ./build/debug_symbols.elf # set function starting point at 0x7c00
